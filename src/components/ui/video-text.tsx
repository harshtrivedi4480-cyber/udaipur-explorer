...
export function VideoText({
  ...
  return (
    <Component className={cn("relative size-full", className)}>
      ...
      >
        <img
          src="https://plus.unsplash.com/premium_photo-1697729417675-be7405664d46?auto=format&fit=crop&fm=jpg&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&ixlib=rb-4.1.0&q=80&w=2000"
          alt="Udaipur city and Lake Pichola"
